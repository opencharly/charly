  ...
  properties: {
    beds: {
      ...
      items: {
        ...
        properties: {
          bed: { type: 'string' },
          target: { type: 'string', description: 'pod | vm | local | kubernetes | android | group' },

...
candies counted elsewhere on this page.
...
| every command, flag and verb | [CLI reference](https://opencharly.ai/reference/cli/fleet/) + [The charly CLI](https://opencharly.ai/guides/the-cli/) |

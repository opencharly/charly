...
// bundle_test_helpers_test.go — the shared spec.CandyReader test-fixture constructors relocated
...
// spec.BundleNode fixtures directly (bypassing the loader) stamp descents against this literal
...
// which build BundleNode literals directly bypassing the loader, run against

...
//     already a pure sdk/deploykit function (candy/plugin-bundle's own compile.go loop
...
// syntheticVmBoxFromEnvelope mirrors charly/bundle_add_cmd.go's syntheticVmBox exactly

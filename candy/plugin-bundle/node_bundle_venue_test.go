...
// node_bundle_venue_test.go — relocated (in part) from charly/node_bundle_venue_test.go (#55
...
// deploy_chain_test.go), zero charly dep. TestFlattenBundleVenues_* is Batch C's concern

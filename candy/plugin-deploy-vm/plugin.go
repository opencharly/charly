...
// pluginDeployTarget (charly core, S3b — was externalDeployTarget before the deploy-dispatch
// cluster moved) reaches it via candy/plugin-bundle's Invoke(OpDeployDispatch) →

// Command serve is the OUT-OF-PROCESS entrypoint for the file kit check verb (M1):
...
import (
	file "github.com/opencharly/charly/candy/plugin-file"
	"github.com/opencharly/sdk"
)

func main() {
	sdk.ServeCheckVerb(file.NewCheckVerb(), "2026.176.2700", file.SchemaFS, file.SchemaDir, file.InputDefs)
}

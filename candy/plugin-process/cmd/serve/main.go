// Command serve is the OUT-OF-PROCESS entrypoint for the process kit check verb (M1):
...
import (
	process "github.com/opencharly/charly/candy/plugin-process"
	"github.com/opencharly/sdk"
)

func main() {
	sdk.ServeCheckVerb(process.NewCheckVerb(), "2026.176.1600", process.SchemaFS, process.SchemaDir, process.InputDefs)
}

...
type deployPreresolver func(name, dir string, node *spec.BundleNode, plans []*deploykit.InstallPlan) (json.RawMessage, error)
...
func wireDeployPreresolver(gp *grpcProvider) deployPreresolver {
	return func(name, dir string, node *spec.BundleNode, plans []*deploykit.InstallPlan) (json.RawMessage, error) {

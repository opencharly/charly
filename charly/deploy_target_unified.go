...
type UnifiedDeployTarget interface {
	...
	Add(ctx context.Context, dctx *DeployContext, plans []*spec.InstallPlan, opts spec.EmitOpts) error
	...
	Update(ctx context.Context, plans []*spec.InstallPlan, opts UpdateOpts) error
}

...
// embeddedDefaults parses the binary-embedded node-form defaults into a spec.UnifiedFile
...
func embeddedDefaults() (*spec.UnifiedFile, error) {
...
func applyEmbeddedDefaults(uf *spec.UnifiedFile) error {

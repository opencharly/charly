...
// host_build_remote_image_resolve.go — the "remote-image-resolve" HostBuild seam behind
// candy/plugin-build's build:ensure word (core-min wave 3, build-engine cluster relocation): a
// thin wrapper around the EXISTING ResolveRemoteImage (remote_image.go, unchanged, still used
// directly by BuildCmd.buildRemote for `charly box build @ref`) that hands the plugin just what

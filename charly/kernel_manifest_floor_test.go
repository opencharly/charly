...
var residueOwner = map[string]string{
	"agent_config.go":                      "P12",
	"agent_forward.go":                     "P11",
	"android_deploy_cmd.go":                "P11",
	"android_deploy_preresolve.go":         "P11",
	"android_spec.go":                      "P11",
	"arbiter_host.go":                      "P15",
	"box_labels_cmd.go":                    "P14",
	"builder_preresolve.go":                "P8b",
	"builder_venue.go":                     "P8b",
	"build.go":                             "P8b",
	"buildkit_aliases.go":                  "P15",
	"build_overlay.go":                     "P8b",
	"build_stage_atomic.go":                "P8b",
	"build_target_oci.go":                  "P8b",
	"bundle_add_cmd.go":                    "P13",
	"bundle_add_cmd_k8s.go":                "P13",
	"bundle_add_cmd_vm.go":                 "P13",
	"bundle_cmd.go":                        "P13",
	"bundle_from_box_cmd.go":               "P13",
	"bundle_members.go":                    "P11",
	"calamares_types.go":                   "P15",
	"candy_chain.go":                       "P8b",
	"candy_model_accessors.go":             "P8b",
	"candy_model_render_accessors.go":      "P8b",
	"capabilities.go":                      "P14",
	"cdp_preresolve.go":                    "P12",
	"check_bed_run.go":                     "P12",
	"check_cmd.go":                         "P12",
	"check_feature_grader.go":              "P12",
	...
	"deploy_host_helpers.go":               "P13",
	"deploy_nodeform.go":                   "P13",
	"deploy_ref.go":                        "P13",
	"deploy_target_pod.go":                 "P11",
	"deploy_tree.go":                       "P13",
	"deploykit_aliases.go":                 "P15",
	"deploykit_candymodel_alias.go":        "P15",
	"deploykit_candyref_aliases.go":        "P15",
	"deploykit_compiler_aliases.go":        "P15",
	"deploykit_compiler_helper_aliases.go": "P15",
	"deploykit_state_aliases.go":           "P15",
	"deploykit_tree_aliases.go":            "P15",
	"description_collect.go":               "P12",
	"description_run.go":                   "P12",
	"description_spec.go":                  "P12",
	"distro.go":                            "P8b",
	"distro_resolve.go":                    "P8b",
	"effective_version.go":                 "P8b",
	"egress.go":                            "P15",
	...
	"k8s_plugin.go":                        "P11",
	"kit_aliases.go":                       "P15",
	"kit_container_name_aliases.go":        "P15",
	"kit_engine_aliases.go":                "P15",
	"kit_env_aliases.go":                   "P15",
	"kit_envfile_aliases.go":               "P15",
	"kit_executor_aliases.go":              "P15",
	"kit_http_fetch_aliases.go":            "P15",
	"kit_ledger_aliases.go":                "P15",
	"kit_refs_aliases.go":                  "P15",
	"kit_reverse_aliases.go":               "P15",
	"kit_runtime_config_aliases.go":        "P15",
	"kit_transfer_aliases.go":              "P15",
	"labelset.go":                          "P8b",
	"labels.go":                            "P8b",
	"layer_artifacts.go":                   "P8b",
	...
	"plan_validate.go":                     "P12",
	"plugin_cmd.go":                        "P15",
	"plugin_command_cmd.go":                "P15",
	"plugin_command_config.go":             "P11",
	"plugin_command_cp.go":                 "P11",
	"plugin_command_logs.go":               "P11",
	"plugin_command_reap_orphans.go":       "P15",
	"plugin_command_remove.go":             "P11",
	"plugin_command_restart.go":            "P11",
	"plugin_command_service.go":            "P11",
	"plugin_command_shell.go":              "P11",
	"plugin_command_ssh.go":                "P15",
	"plugin_command_start.go":              "P11",
	"plugin_command_stop.go":               "P11",
	"plugin_command_update.go":             "P11",
	"plugin_command_volume.go":             "P11",
	...
	"scaffold_cmds.go":                     "P14",
	"scaffold_project.go":                  "P14",
	"secrets.go":                           "P11",
	"security.go":                          "P11",
	"service.go":                           "P11",
	...
	"sidecar.go":                           "P11",
	"ssh.go":                               "P15",
	"ssh_config_aliases.go":                "P15",
	"start.go":                             "P11",
	"status_collect_adb.go":                "P14",
	"status_collect_k8s.go":                "P14",
	"status_collect_local.go":              "P14",
	"status_collect_pod.go":                "P14",
	"status_collect_vm.go":                 "P14",
	"status_collector.go":                  "P14",
	"status_nested.go":                     "P14",
	"status_probes.go":                     "P14",
	"status_reap.go":                       "P14",
	"status_substrate.go":                  "P14",
	...
	"vm_bootc_install.go":                  "P8b",
	"vm_bootstrap.go":                      "P8b",
	"vm_build.go":                          "P8b",
	"vm_cloud_image.go":                    "P8b",
	"vm_disk_builder.go":                   "P8b",

...
var kernelFloor = []floorEntry{
	...
	{"config.go", "M — the thin host LoadConfig/LoadConfigRaw entry seams over loaderkit.LoadUnified + uf.ProjectConfig, plus resolveVocabOpts (the host projection loading the project vocabulary into loaderkit.ResolveOpts). The load ORCHESTRATION moved to loaderkit (#48); this is the thin host loader entry"},

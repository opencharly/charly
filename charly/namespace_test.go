...
func TestImportList_Unmarshal(t *testing.T) {
	root := t.TempDir()
	writeFixture(t, root, "charly.yml", `version: 2026.203.2359
import:
  - build.yml
  - sub: ./sub.yml
`)
  ...
  build: [rpm]
`)
	writeFixture(t, root, "sub.yml", `version: 2026.203.2359
widget:
  candy:
...
app:
  candy:
    ...
    distro: [fedora]
`)
	writeFixture(t, root, "sub/charly.yml", `version: 2026.203.2359
import:
  - up: ../
widget:
  candy:

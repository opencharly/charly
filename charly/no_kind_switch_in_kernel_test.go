...
// P9) — that gate only catches a bare `.Target == "word"` BinaryExpr over a substrate
...
// polices, per the W5 brief: the 7 deploy substrates plus the 3 entity/verb words whose

...
func TestRelocatedInterfaceVerb_DispatchesViaKit(t *testing.T) {
	...
	res := cv.RunVerb(context.Background(), hostVerbResolverFor(fePresent, spec.CheckModeLive),
	...
	res2 := cv.RunVerb(context.Background(), hostVerbResolverFor(feAbsent, spec.CheckModeLive),

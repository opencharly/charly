...
const (
	...
	// provider and an out-of-process plugin serve identical behavior. Compiled-in because the
	// engine is needed for local-image probes / box pull before any project plugin loads — the
	// same bootstrap reasoning as ClassLoader/ClassRefs.

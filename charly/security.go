...
// appendUnique appends items to dst, skipping any already present in dst. Shared by
// devices.go/config_image.go/pod_lifecycle_resolve.go (the pod-deploy subsystem, K4).

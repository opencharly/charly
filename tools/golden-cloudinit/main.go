...
// charly/testdata/cloudinit_egress_golden_userdata.yaml and
// charly/testdata/cloudinit_egress_golden_metadata.yaml that
// charly/egress_test.go's TestRenderCloudInit_OutputValidatesAgainstSchema loads via plain
// os.ReadFile — no sdk import needed there anymore.
//
...
// charly's real ValidateEgress gate end-to-end" — sdk/vmshared's OWN test suite stubs
...
// golden files. The charly-side test then re-validates those golden bytes against its OWN real
// ValidateEgress — proving the identical invariant, driven from a golden fixture instead of a
// live sdk call.
//
...
const (
	userDataGoldenRelPath = "charly/testdata/cloudinit_egress_golden_userdata.yaml"
	metaDataGoldenRelPath = "charly/testdata/cloudinit_egress_golden_metadata.yaml"
)
